...
if __name__ == "__main__":
    ...
    train_set1 = [i for i in data if i[-1] == 'Roach'][:40]
    train_set2 = [i for i in data if i[-1] == 'Pike'][:40]

    treebuildr = train_set1 + train_set2

    tree = build_tree(treebuildr)

    print(list(classify(test_case, tree))[0])
