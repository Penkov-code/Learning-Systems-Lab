...
if __name__ == "__main__":
    ...
    train_set1 = dataset[:int(len(dataset)*0.8)]
    ...
    acc1 = counter1 / len(test_set1)
    acc2 = counter2 / len(test_set2)

    print(f'Tochnost so prvoto drvo na odluka: {acc1}')
    print(f'Tochnost so vtoroto drvo na odluka: {acc2}')