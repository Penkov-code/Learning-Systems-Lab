...
class DecisionNode:
    def __init__(self, col=-1, value=None, results=None, level=None, tb=None, fb=None):
        """
...
if __name__ == "__main__":
    ...
    test_set = [x1, x2, x3, x4, xstr]
    train_set1 = training_data[:int(len(training_data)*0.5)]
    train_set2 = training_data[int(len(training_data)*0.5):]

    tree1 = build_tree(train_set1, 0)
    tree2 = build_tree(train_set2, 0)

    cl1 = list(classify(test_set, tree1))[0]
    cl2 = list(classify(test_set, tree2))[0]
