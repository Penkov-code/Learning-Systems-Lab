...
if __name__ == '__main__':
    ...
    cl1 = list(classify(test_case, tree1))[0]
    cl2 = list(classify(test_case, tree2))[0]
    cl3 = list(classify(test_case, tree3))[0]

    classes = sorted([row[-1] for row in dataset])
    for cl in classes:
        recnik.setdefault(cl, 0)
    ...
    if lista[0][1] == lista[1][1]:
        ...
        print(f'Predvidena klasa: {str(lista[0][0])}')