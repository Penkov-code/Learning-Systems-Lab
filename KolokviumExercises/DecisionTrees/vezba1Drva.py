...
if __name__ == "__main__":
    ...
    train_set1 = data[:int(len(data)*0.5)]
    train_set2 = data[int(len(data) * 0.5):]

    tree1 = build_tree(train_set1)
    tree2 = build_tree(train_set2)

    class1 = classify(test_set, tree1)
    class2 = classify(test_set, tree2)

    if list(class1.keys())[0] == list(class2.keys())[0]:
        print(list(class1.keys())[0])
    else:
        print("KONTRADIKCIJA")
