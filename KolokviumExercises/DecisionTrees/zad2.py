...
if __name__ == '__main__':
    ...
    nb = NaiveBayes(get_words)
    nb2 = NaiveBayes(get_words_emoji)

    for doc in train_set:
        nb.train(doc[1], doc[0])
        nb2.train(doc[1], doc[0])

    for i in range(0, len(test_set)):
        predictclass1 = nb.classify_document(test_set[i][1])
        predictclass2 = nb2.classify_document(test_set[i][1])
        print(str(i+1) + ":")
        print(str(test_set[i][1]))
        print("Vistinska klasa: " + str(test_set[i][0]))
        print("Klasa predvidena so Naiven Baes (bez emotikoni): " + str(predictclass2))
        print("Klasa predvidena so Naiven Baes (so emotikoni): " + str(predictclass1))
