...
if __name__ == '__main__':
    ...
    print(test_set[1])
    print(f'Vistinska klasa: {str(test_set[0])}')
    print(f'Klasa predvidena so Naiven Baes (bez emotikoni): {nb1.classify_document(test_set[1])}')
    print(f'Klasa predvidena so Naiven Baes (so emotikoni): {nb2.classify_document(test_set[1])}')