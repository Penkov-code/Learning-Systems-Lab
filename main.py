...
if __name__ == '__main__':
    ...
    for i in range(len(test_set)):
        ...
        prediction1 = nb1.classify_document(test_set[i][1])
        prediction2 = nb2.classify_document(test_set[i][1])
        print("Klasa predvidena so Naiven Baes (bez emotikoni): " + str(prediction1))
        print("Klasa predvidena so Naiven Baes (so emotikoni): " + str(prediction2))
