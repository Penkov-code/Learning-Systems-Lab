...
if __name__ == "__main__":
    ...
    for i in range(len(train_setFirst)):
        cl.train(train_setFirst[i], train_setLast[i])

    x = cl.classify_document(recenica)
    print(x)
    prob = cl.get_category_probability_for_document(recenica,x)
    print(round(prob,10))
#.split(" \"\"\" ")
#"""Armed with a bachelors degree in botany and a masters in microbiology, Hoffman moved to Charlotte where she became director of the Charlotte Nature Museum. """